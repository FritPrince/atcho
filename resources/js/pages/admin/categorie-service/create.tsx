...
export default function CategorieServiceCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/categories-services');
    };
    ...
    return (
        <AdminLayout>
            <Head title="Créer une Catégorie de Service" />
            ...
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Créer une Catégorie de Service</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Remplissez les informations pour créer une nouvelle catégorie de service
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
