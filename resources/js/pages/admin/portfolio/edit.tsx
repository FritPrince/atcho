...
export default function PortfolioEdit({ portfolio }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        createur_id: portfolio.createur_id.toString(),
        images: [] as File[],
    });
    ...
    return (
        <AdminLayout>
            <Head title={`Modifier - ${portfolio.titre}`} />
            ...
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Modifier le portfolio</h1>
                        <p className="text-muted-foreground">
                            Modifiez les informations de {portfolio.titre}
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Modifiez les informations du portfolio
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="images">Nouvelles images (optionnel)</Label>
                                <Input
                                    id="images"
                                    type="file"
                                    multiple
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Formats acceptés: JPG, PNG, GIF. Laissez vide pour conserver les images actuelles.
                                </p>
                                {errors.images && (
