...
export default function SignalementEdit({ signalement }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        type: signalement.type,
        description: signalement.description,
        statut: signalement.statut,
        priorite: signalement.priorite,
        date_signalement: signalement.date_signalement ? new Date(signalement.date_signalement).toISOString().slice(0, 16) : '',
        signalant_id: signalement.signalant_id.toString(),
        signale_id: signalement.signale_id.toString(),
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/signalements/${signalement.id}`);
    };
    ...
    const statuts = [
        { value: 'en_attente', label: 'En attente', description: 'Signalement en attente de traitement' },
        { value: 'en_cours', label: 'En cours', description: 'Signalement en cours de traitement' },
        { value: 'resolu', label: 'Résolu', description: 'Signalement résolu' },
        { value: 'rejete', label: 'Rejeté', description: 'Signalement rejeté' }
    ];

    return (
        <AdminLayout>
            <Head title={`Modifier - ${signalement.type}`} />
            ...
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Modifier le signalement</h1>
                        <p className="text-muted-foreground">
                            Modifiez les informations du signalement "{signalement.type}"
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Modifiez les informations du signalement
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
