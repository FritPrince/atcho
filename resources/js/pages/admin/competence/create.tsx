...
export default function CompetenceCreate() {
    ...
    return (
        <AdminLayout>
            <Head title="Créer une Compétence" />
            ...
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Créer une Compétence</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Remplissez les informations pour créer une nouvelle compétence
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
