...
export default function ReportEdit({ report }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        nom: report.nom || '',
        description: report.description || '',
        type: report.type || '',
        statut: report.statut || '',
        parametres: report.parametres ? JSON.stringify(report.parametres, null, 2) : '',
    });
    ...
    return (
        <AdminLayout>
            <Head title={`Modifier: ${report.nom}`} />
            ...
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Modifier le Rapport</h1>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifiez les paramètres de base du rapport
                                </CardDescription>
                            </CardHeader>
