...
export default function PaiementEdit({ paiement }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        montant: paiement.montant.toString(),
        methode: paiement.methode,
        statut: paiement.statut,
        reference: paiement.reference,
        date_paiement: paiement.date_paiement ? new Date(paiement.date_paiement).toISOString().slice(0, 16) : '',
        commande_id: paiement.commande_id.toString(),
        utilisateur_id: paiement.utilisateur_id.toString(),
    });
    ...
    return (
        <AdminLayout>
            <Head title={`Modifier - Paiement #${paiement.id}`} />
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Modifiez les informations du paiement #{paiement.id}
                        </p>
                    </div>
                </div>
